...
Summary  : Extension for the DBus bindings
...
cp %{_builddir}/Net-DBus-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-Net-DBus/5e1d5de27665f510e08e30949e623d8fbd50ac53 || :
if test -f Makefile.PL; then
